...
pub const ENTRY_FS_BLUR: &str = "fs_blur";
pub const ENTRY_FS_THRESHOLD: &str = "fs_threshold";
pub const ENTRY_FS_UPSCALE: &str = "fs_upscale";
...
pub fn create_shader_module(device: &wgpu::Device) -> wgpu::ShaderModule {
    let source = std::borrow::Cow::Borrowed(include_str!("bloom.wgsl"));
    device
